...
TState extends AxFlowState = IN> implements AxFlowable<IN, OUT> {
    ...
    streamingForward<T extends Readonly<AxAIService>>(ai: T, values: IN | AxMessage<IN>[], options?: Readonly<AxProgramStreamingForwardOptionsWithModels<T> & {
...
type AxAgentOptions = Omit<AxProgramForwardOptions<string>, 'functions' | 'description'> & {
    debug?: boolean;
    /** Input fields holding long context (will be removed from the LLM prompt). */
    contextFields: string[];
...
declare class AxAgent<IN extends AxGenIn, OUT extends AxGenOut> implements AxAgentic<IN, OUT> {
    ...
    constructor({ ai, agentIdentity, signature, }: Readonly<{
        ai?: Readonly<AxAIService>;
 ...
 * ```
 */
declare function agent<const T extends string, const CF extends readonly string[]>(signature: T, config: Omit<AxAgentConfig<ParseSignature<T>['inputs'], ParseSignature<T>['outputs']>, 'contextFields'> & {
    contextFields: CF;
}): AxAgent<ParseSignature<T>['inputs'], ParseSignature<T>['outputs']>;
declare function agent<TInput extends Record<string, any>, TOutput extends Record<string, any>, const CF extends readonly string[]>(signature: AxSignature<TInput, TOutput>, config: Omit<AxAgentConfig<TInput, TOutput>, 'contextFields'> & {
    contextFields: CF;
