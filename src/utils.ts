    ...
    for (const entry of entries) {
        ...
        if (stat.isDirectory()) {
            ...
            try {
                ...
                console.warn(`File ${fullPath} skipped due to read/encoding issues: ${(error as Error).message}`);
            }
        }
    }
 ...
 */
export function saveAgentsToDisk(repoName: string, agentsContent: string, baseDir: string = "projects"): void {
